...
class QBTask(Status):
    ...
    async def create_message(self):
        ...
        msg += "<b>├⚠️ Seeders:-</b> <u>{}</u> | <b>Peers:-</b> <u>{}</u>\n".format(
            self._torrent.num_seeds,self._torrent.num_leechs
            )
        msg += "│\n<b>╰─「</b>⚡ <i>Using engine</i>: <code>qBittorrent</code>」"
...
class ARTask(Status):
    ...
    async def create_message(self):
        ...
        msg = f"\n<b>╭────「</b>📥 <i>Downloading</i>」\n│\n<b>├📚 File Name:</b> <code>{downloading_dir_name}</code>"
        msg += "\n<b>├🚀 Down Speed:</b> <code>{}</code> \n<b>Up Speed:</b> <code>{}</code>\n".format(
        ...
        msg += "<b>├📡 Conns:</b>{} <b>".format(
            self._dl_file.connections
            )
        msg += f"\n│\n<b>╰─「</b><i>⚡ Using Engine:</i> <code>Aria2 For DirectLinks</code>」"
